...
namespace Bot.Builder.Community.Twitter.Webhooks.Services
{
    ...
    public class WebhooksPremiumManager
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Bot.Builder.Community.Twitter.Webhooks.Services.WebhooksPremiumManager"/> class.
        /// </summary>
        /// <param name="context">Context.</param>
        public WebhooksPremiumManager(TwitterAuthContext context)
        {
            AuthContext = context;
        }
